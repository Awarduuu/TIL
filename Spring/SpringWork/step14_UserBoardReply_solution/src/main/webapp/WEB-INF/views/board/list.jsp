		    ...
		    <tr>
		        ...
		        <td>
					<a href="${pageContext.request.contextPath}/board/read/${board.bno}"> 
					  ...
					  <b style="color:red"> ${board.replyList.size() } </b>
					</a>
...
<div style="text-align: center">
 ...
 <nav class="pagination-container">
	...
	<c:set var="doneLoop" value="false"/> <!-- 변수 하나 설정 -->
		...
		<span class="pagination-inner"> 
		  <c:forEach var='i' begin='${startPage}' end='${(startPage-1)+blockCount}'> <!-- foreach의 단점은 break 이 없음 -->
